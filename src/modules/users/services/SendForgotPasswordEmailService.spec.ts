...
describe('SendForgotPasswordEmail', () => {
  ...
  it('should be able to recover the password using the email', async () => {
    ...
    await fakeUsersRepository.create({
      name: 'Bruno Jagmin',
      email: 'brunojagmin@gmail.com',
      password: '123456',
    });

    await sendForgotPasswordEmail.execute({ email: 'brunojagmin@gmail.com' });
  ...
  it('should not be able to recover a non-existing user password', async () => {
    await expect(
      sendForgotPasswordEmail.execute({ email: 'brunojagmin@gmail.com' }),
